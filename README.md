...
<p align="center">
  <picture>
    ...
    <img
      ...
      width="600"
      alt="A terminal session. yuki whoami prints an ASCII fish beside: hi, i'm yuki. I build AI agents, eval systems, and developer tools. yuki background prints: I studied architecture before I wrote code. yuki what-keeps-me-curious prints: the jump from it works to it's useful, building it, testing it, finding out."
    />
  </picture>
</p>
